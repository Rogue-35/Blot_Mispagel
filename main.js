...
const genPrecision = bt.randInRange(.000001, 1.500000);
...
drawLines([EarRight]);
const aboveEarRight = generateArcs(96.7, 80, .6, 2, 11.55, 12, 20, 60, genPrecision, false);
drawLines([aboveEarRight]);
const eyeRight = generateArcs(50.5, 85, 7,7, 3, 3, 0, 360, genPrecision, false);
drawLines([eyeRight])
const eyeLeft = generateArcs(80.5, 85, 7,7, 3, 3, 0, 360, genPrecision, false);
drawLines([eyeLeft])
